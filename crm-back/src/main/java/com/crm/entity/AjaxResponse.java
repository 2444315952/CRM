...
public class AjaxResponse {
     ...
     */
    public static com.crm.entity.AjaxResponse error(CustomError e) {

        com.crm.entity.AjaxResponse resultBean = new com.crm.entity.AjaxResponse();
     ...
     * @return AjaxResponse 封闭后的响应对象
     */
    public static com.crm.entity.AjaxResponse success() {
        com.crm.entity.AjaxResponse resultBean = new com.crm.entity.AjaxResponse();
     ...
     * @return AjaxResponse 封闭后的响应对象
     */
    public static com.crm.entity.AjaxResponse success(Object data) {
       com.crm.entity.AjaxResponse resultBean = new com.crm.entity.AjaxResponse();
        resultBean.setSuccess(true);
        resultBean.setCode(200);
        resultBean.setMessage("success");
